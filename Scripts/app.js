...
// Here we inject all the paragraphs under the images
(function () {
	//paragraph 1
	...
	//paragraph 2
	if (document.getElementById("Folegandros") != null) {
	...
	//paragraph 3
	if (document.getElementById("Alonissos") != null) {
	...
	//paragraph 4
	if (document.getElementById("Spetses") != null) {
	...
	//paragraph 5
	if (document.getElementById("Amorgos") != null) {
	...
	//paragraph 6
	if (document.getElementById("Syros") != null) {
		...
		//paragraph 7
	if (document.getElementById("Milos") != null) {
		...
		//paragraph 8
	if (document.getElementById("Hydra") != null) {
		...
		//paragraph 9
	if (document.getElementById("Ithaca") != null) {
		...
		//paragraph 10
	if (document.getElementById("Gavdos") != null) {
